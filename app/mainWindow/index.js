...
export const directories = [
  `${homedir}/.lumanexwallet`,
  `${homedir}/.lumanexwallet/logs`
];
...
remote.app.setAppUserModelId('wallet.lumanex');

log.debug(`Lumanex Wallet started...`);
  ...
  const message = (
    <div>
      ...
      <p className={`subtitle ${textColor}`}>
        There&apos;s a new version of Lumanex Wallet available. Would you like to
        download it?
      </p>
    </div>
  );
